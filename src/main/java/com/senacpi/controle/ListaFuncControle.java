...
import com.senacpi.dao.ListaFuncDao;
 ...
 * @author Jake mk
 */
public class ListaFuncControle {
    ...
    public static void pesquisaFiltroDinamico(JTextField txtPesquisa, JTable tblFuncionarios) {
        ...
        try {
            ListaFuncDao listaDao = new ListaFuncDao();
            //sem a linha abaixo dá erro 
            ListaFuncControle lControle = new ListaFuncControle();
