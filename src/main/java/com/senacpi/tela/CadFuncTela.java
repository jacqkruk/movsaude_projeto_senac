...
import com.senacpi.controle.CadFuncControle;
import com.senacpi.controle.CadPacControle;
import com.senacpi.dao.FuncDao;
 ...
 * @author Jake mk
 */
public class CadFuncTela extends javax.swing.JFrame {

    private Funcionario funcEdicao = null;
    ...
    public CadFuncTela() {
        initComponents();
        CadFuncControle.preencherComboSetor(cboxSetor);
        txtId.setEnabled(false);
    }

    public void preencheEdicao(Funcionario f) {
        CadFuncControle.prepararEdicao(f, txtId, cboxSetor, txtNome, txtCpf, txtEmail, txtTel, fmtTxtNasc);
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        CadPacControle CadPacCon = new CadPacControle();
        ...
        if (CadPacCon.validarCampos(nome, cpf, email, tel, dataString)) {
            try {
                //novoFunc.setText(String.valueOf(id));
                novoFunc.setNome(nome);
                novoFunc.setCpf(cpf);
                novoFunc.setEmail(email);
                novoFunc.setTelefone(tel);
                novoFunc.setSetor(cboxSetor.getSelectedItem().toString());
                ...
                if (funcEdicao == null) {
                    funcDao.cadastrar(novoFunc);
                    // mensagem de sucesso
                    JOptionPane.showMessageDialog(this, "Funcionário cadastrado com sucesso.");
                } else {
                    funcDao.editar(funcEdicao);
                    // mensagem de sucesso
