...
import com.senacpi.controle.ListaFuncControle;
 ...
 * @author Jake mk
 */
public class ListagemFuncTela extends javax.swing.JFrame {
     ...
     */
    public ListagemFuncTela(Usuario usuario) {
        initComponents();
        ...
        ListaFuncControle lFuncCon = new ListaFuncControle();
        ListaFuncDao lFuncDao = new ListaFuncDao();
        lFuncDao.listar();
        ...
        try {
            ...
            if (tblFuncionarios.getSelectedRow() >= 0) {
                ...
                if (resposta == 0) {
                    ...
                    ListaFuncControle.pesquisaFiltroDinamico(txtPesquisa, tblFuncionarios);
                }
            } else {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        try {
            ...
            CadFuncTela cadTela = new CadFuncTela();
