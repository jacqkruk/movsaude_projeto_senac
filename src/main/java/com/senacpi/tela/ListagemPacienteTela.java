...
import com.senacpi.controle.ListaPacienteControle;
 ...
 * @author Jake mk
 */
public class ListagemPacienteTela extends javax.swing.JFrame {

    private final Usuario usuario; // Armazena o usuário atualmente autenticado.
    private final ListaPacienteControle lPacCon;
    private final ListaPacienteDao lPacDao;
     ...
     */
    public ListagemPacienteTela(Usuario usuario) {
        initComponents();
        
        // Inicializa dependências
        this.usuario = usuario;// receber tipo de usuário
        this.lPacCon = new ListaPacienteControle();
        this.lPacDao = new ListaPacienteDao();
    ...
    private void txtPesquisaCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtPesquisaCaretUpdate
        ListaPacienteControle.pesquisaFiltroDinamico(txtPesquisa, tblPacientes);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        try {
            ...
            CadastroPacienteTela cadTela = new CadastroPacienteTela();
